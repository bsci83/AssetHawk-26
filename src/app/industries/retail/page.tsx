    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-4xl font-bold text-gray-900">Retail & E-commerce</h1>
        </div>

        <p className="text-xl text-gray-600 mb-8">Connect physical products to digital experiences and inventory.</p>

        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-gray-50 rounded-lg p-6">
            <h3 className="text-xl font-bold mb-3">Product Authentication</h3>
            <p className="text-gray-600">Authenticate luxury goods and high-value items with scannable QR codes that verify authenticity.</p>
          </div>
          <div className="bg-gray-50 rounded-lg p-6">
            <h3 className="text-xl font-bold mb-3">Inventory Management</h3>
            <p className="text-gray-600">Track inventory across warehouses and stores. Know exactly where products are at all times.</p>
          </div>
          <div className="bg-gray-50 rounded-lg p-6">
            <h3 className="text-xl font-bold mb-3">Customer Engagement</h3>
            <p className="text-gray-600">QR codes on products link to rich product information, care instructions, and reorder pages.</p>
          </div>
          <div className="bg-gray-50 rounded-lg p-6">
            <h3 className="text-xl font-bold mb-3">Returns & Warranty</h3>
            <p className="text-gray-600">Streamline returns and warranty claims with QR code verification.</p>
          </div>
        </div>
