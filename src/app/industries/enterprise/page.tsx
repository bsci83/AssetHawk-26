    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-4xl font-bold text-gray-900">Enterprise Assets</h1>
        </div>

        <p className="text-xl text-gray-600 mb-8">Manage IT equipment, facilities, and corporate resources.</p>

        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-gray-50 rounded-lg p-6">
            <h3 className="text-xl font-bold mb-3">IT Asset Management</h3>
            <p className="text-gray-600">Track laptops, monitors, servers, and IT equipment across offices and remote workers.</p>
          </div>
          <div className="bg-gray-50 rounded-lg p-6">
            <h3 className="text-xl font-bold mb-3">Facilities Management</h3>
            <p className="text-gray-600">Track furniture, fixtures, and equipment across multiple buildings and locations.</p>
          </div>
          <div className="bg-gray-50 rounded-lg p-6">
            <h3 className="text-xl font-bold mb-3">Compliance Tracking</h3>
            <p className="text-gray-600">Maintain audit trails and compliance documentation for regulated industries.</p>
          </div>
          <div className="bg-gray-50 rounded-lg p-6">
            <h3 className="text-xl font-bold mb-3">Maintenance Scheduling</h3>
            <p className="text-gray-600">Schedule and track maintenance for all types of corporate assets.</p>
          </div>
        </div>
